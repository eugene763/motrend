...
function renderTemplateCard(t) {
  ...
  div.style.margin = "0";
  div.innerHTML = `
    <video class="tplVideo" autoplay loop muted playsinline preload="metadata" poster="${t.preview?.thumbnailUrl || ""}">
  <source src="${t.preview?.previewVideoUrl || ""}" type="video/mp4">
</video>
