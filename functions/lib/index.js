...
exports.processJobTrigger001 = exports.createJob = void 0;
...
exports.createJob = (0, https_1.onCall)({ cors: true }, async (req) => {
    ...
    if (!/^[\w-]+$/.test(templateId)) {
        throw new https_1.HttpsError("invalid-argument", "Invalid templateId");
    }
...
exports.processJobTrigger001 = (0, firestore_1.onDocumentUpdated)("jobs/{jobId}", async (event) => {
    var _a, _b;
